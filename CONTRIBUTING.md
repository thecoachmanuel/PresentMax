# Contributing to PresentMax AI Presentation Generator

Thank you for your interest in contributing to the PresentMax AI Presentation Generator! This document provides guidelines and instructions for contributing to this project.
...
1. Check if it already exists in the [Issues](https://github.com/thecoachmanuel/PresentMax/issues)
...
- Reach out via the project's communication channels ([GitHub Issues](https://github.com/thecoachmanuel/PresentMax/issues))

## License

By contributing to this project, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).

Thank you for contributing to make PresentMax AI Presentation Generator better for everyone!
